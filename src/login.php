        ...
        if($con->connect_errno==0) {
            ...
            $hash_pass = password_hash($pass, PASSWORD_DEFAULT);
                ...
                mysqli_real_escape_string($con,$login)))) {
                    if($res->num_rows==1) {
                        $row = $res->fetch_assoc();
                        if(password_verify(mysqli_real_escape_string($con,$pass),$hash_pass)) {
            ...
            echo "Err: ".$con->connect_errno." W razie problemów skontaktuj się z twórcą panelu - Discord: NexON39#5665";
    } else {
        $_SESSION['alert'] = "
        <div class='alertbox'>
