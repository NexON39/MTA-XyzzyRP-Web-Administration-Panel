<?php
    ...
    class operations extends mtaconfig
    {
        ...
        public function ban() {
            ...
            $response = $this->mtaconnect()->getResource('siema')->call('xyzzyrp_ap_ban',$ban_uid,$ban_time,$ban_unit,$ban_reason);
            return $response;
        }
        ...
        public function kick() {
            ...
            $response = $this->mtaconnect()->getResource('siema')->call('xyzzyrp_ap_kick',$kick_uid,$kick_reason);
            return $response;
        }
